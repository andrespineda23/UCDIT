...
@ManagedBean
@SessionScoped
public class ControllerRegistrarTipoPersonal implements Serializable {
    ...
    public ControllerRegistrarTipoPersonal() {
    }
     ...
     * del nuevo docente
     */
    public void registrarNuevoTipoPersonal() {
        if (validarResultadosValidacion() == true) {
            almacenarNuevoTipoPersonalEnSistema();
            limpiarFormulario();
    ...
    public void almacenarNuevoTipoPersonalEnSistema() {
        try {
            TipoPersonal nuevaTipoPersonal = new TipoPersonal();
            nuevaTipoPersonal.setNombretipopersonal(nuevoNombre);
            administrarTipoPersonalBO.crearTipoPersonal(nuevaTipoPersonal);
        } catch (Exception e) {
            System.out.println("Error ControllerRegistrarTipoPersonal almacenarNuevoTipoPersonalEnSistema : " + e.toString());
        }
    }
